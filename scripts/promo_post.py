"""
FitnessDailyTips - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "desc": "Plan and track your workouts with our comprehensive Notion fitness planner.",
        "keywords": ["workout planning", "exercise routine", "gym tracking", "fitness goals"],
    },
    {
        "name": "Fitness Goal Tracker",
        "price": "$5.99",
        "slug": "fitness-tracker",
        "desc": "Set and crush your fitness goals with our Notion goal tracker.",
        "keywords": ["fitness goals", "progress tracking", "body transformation", "weight tracking"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert fitness and exercise writer.
