"""
FitnessDailyTips - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Workout Planner", "price": "$7.99", "slug": "workout-planner", "desc": "Plan your workouts like a pro with 100+ exercise library."},
    {"name": "Fitness Goal Tracker", "price": "$5.99", "slug": "fitness-goals", "desc": "Set and crush your fitness goals with visual progress tracking."},
]

PROMO_SYSTEM_PROMPT = """You are an expert fitness writer.
